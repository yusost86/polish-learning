...
export const SCENARIO_STUDENT_ID = "student-1";
export const SCENARIO_NOW = new Date("2026-08-23T12:00:00.000Z");
...
export const DAILY_LIFE_WORDS: Word[] = [
...
export const ALL_SCENARIO_WORDS: Word[] = [...TRAVEL_WORDS, ...FOOD_WORDS, ...DAILY_LIFE_WORDS];
